...
namespace EleganceCMS\Api\Facades;

use EleganceCMS\Api\Supports\ApiHelper as ApiHelperSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static string modelName()
 * @method static \EleganceCMS\Api\Supports\ApiHelper setModelName(string $modelName)
 ...
 *
 * @see \EleganceCMS\Api\Supports\ApiHelper
 */
