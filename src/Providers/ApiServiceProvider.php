...
namespace EleganceCMS\Api\Providers;

use EleganceCMS\Api\Facades\ApiHelper;
use EleganceCMS\Api\Commands\GenerateDocumentationCommand;
use EleganceCMS\Api\Http\Middleware\ForceJsonResponseMiddleware;
...
use EleganceCMS\Setting\PanelSections\SettingCommonPanelSection;
